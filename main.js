function initProcess() {
    ...
    $("#result-wait-5").css('display', 'block');
    $("#result-wait-6").css('display', 'none');
    $("#result-wait-7").css('display', 'none');
}
...
function downloadStatus(url, title, id, ext, totalSize, note, format, countP) {
            ...
            success: function(kdata) {
                if (countP == count) {
                    ...
                    if (kdata.status == 'success') {
                        ...
                        setTimeout(function() {
                            downloadStatus(url, title, id, ext, totalSize, note, format, countP);
                        }, 4000)
                        if (kdata["type"] != undefined && kdata["type"] == "downloading") {
                            ...
                            $("#result-wait-5").css('display', 'none');
                            $("#result-wait-6").css('display', 'none');
                            $("#result-wait-7").css('display', 'none');
                        ...
                        if (kdata["type"] != undefined && kdata["type"] == 'analyse_start') {
                            console.log(kdata["type"])
                            $("#result-wait-1").css('display', 'none');
                            $("#result-wait-2").css('display', 'none');
                            $("#result-wait-3").css('display', 'none');
                            $("#result-wait-4").css('display', 'none');
                        ...
                        if (kdata["type"] != undefined && kdata["type"] == 'retry_analyse_start') {
                            console.log(kdata["type"])
                            $("#result-wait-1").css('display', 'none');
                            $("#result-wait-2").css('display', 'none');
                            $("#result-wait-3").css('display', 'none');
                            ...
                            $("#result-wait-5").css('display', 'none');
                            $("#result-wait-7").css('display', 'none');
                            $("#result-wait-6").css('display', 'block');
                        }
                        if (kdata["type"] != undefined && kdata["type"] == 'download_start') {
                            console.log(kdata["type"])
                            $("#result-wait-1").css('display', 'none');
                            $("#result-wait-2").css('display', 'none');
                            $("#result-wait-3").css('display', 'none');
                            ...
                            $("#result-wait-5").css('display', 'none');
                            $("#result-wait-6").css('display', 'none');
                            $("#result-wait-7").css('display', 'block');
                        }
                    } else {
                        showDownloadErrorModal("Some errors occurred during conversion, try again or use another link")
                    }
                }
            ...
            success: function(kdata) {
                if (countP == count) {
                    ...
                    if (kdata.status == 'success') {
                        ...
                        status_stop = true;
                        showDownloadErrorModal("Service is busy, Please try again later!")
                    } else if (kdata.status == 'country_error' || kdata.status == 'unsupported_url') {
                        status_stop = true;
                        showDownloadErrorModal("Not support this link, please use another link!")
                    } else if (kdata.status == 'live_error') {
                        status_stop = true;
                        showDownloadErrorModal("The live broadcast has just ended. You need to wait 3-7 days before downloading")
                    } else if (kdata.status == 'sign_in_error' || kdata.status == 'timed_out_error' || kdata.status == 'not_response') {
                        status_stop = true;
                        showDownloadErrorModal("Some errors occurred during conversion, please try again!")
                    } else {
                        status_stop = true;
                        showDownloadErrorModal("Some errors occurred during conversion, try again or use another link!")
                    }
...
function analyze(retry) {
    ...
    turnstile.render("#captchaContainer", {
        sitekey: "0x4AAAAAAAzuNQE5IJEnuaAp",
        ...
        errorCallback: function(error) {
            ...
            $("#result").empty().append("<div class=\"tabs row\">\n" +
                ...
                "                                <span class=\"sr-only\">Error : </span> Challenge Failed, Please try again later<br>  \n" +
                "                            </div> \n" +
                "                        </div>\n" +
                "                    </div>\n" +
